    ...
    <q-page class="q-pa-md q-pa-md add_art_wrap">
      ...
      <div style="margin-left: 5%;">
            ...
            <tr>
                <div class="q-pt-lg">
                    <td class="labal-input">
                        ...
                        />
                        <q-input class="sale" v-model="mediaPrice" :disabled="!forSale" :label="$t('media_price')" ref="mediaPrice" :rules="[required, val => minLength(val, 1), val => maxLength(val, 100)]" clearable tabindex="1" />
                    </td>
                </div>
            </tr>
            <tr>
        ...
        <div class="row justify-center">
            ...
            <div class="col-12">
                <img v-if="mediaImage" :src="mediaImage" style="width: 100%;">
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      fileUploadedMedia (file, xhr) {
        ...
        this.mediaImage = fileNameNew // 프로젝트 로고 URL 설정
        // this.$refs.uploaderObj.reset()
      },
      goBack() {
        // this.$router.go(-1)
