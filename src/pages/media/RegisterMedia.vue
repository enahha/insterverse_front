...
export default defineComponent({
  ...
  data () {
    return {
      ...
      mediaDescription: '"Feeling Good" is the base It is a collection of works that contain travel and daily life in my own way so that the emotions do not volatilize.\r\n "기분좋은 감정"이 베이스 입니다 그 감정이 휘발되지 않게 제 방식으로 여행과 일상을 담은 작업물들로 이뤄진 컬렉션입니다.',
      mediaForSale: true,
      mediaUrl: '',
      mediaThumnailUrl: '',
