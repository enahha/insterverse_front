<template>
  <div class="row justify-center vote-detail-header">
  ...
  <!-- Side Area -->
  <div v-if="smallSize">
    <div class="page-side-bar vote-type">
      ...
      <!-- progress -->
      <div class="row justify-center q-pt-md progress-tit-wrap">
      ...
      <div class="row justify-center progress-wrap">
        <div class="col-9">
          <q-linear-progress size="40px" :value="progressAgree" color="green-5" rounded>
      ...
      <div class="row justify-center q-pt-lg progress-tit-wrap">
        <div class="col-9 text-left">
      ...
      <div class="row justify-center progress-wrap">
        <div class="col-9">
          <q-linear-progress size="40px" :value="progressDisagree" color="red-5" rounded>
            <div class="absolute-full flex flex-center">
              <q-badge color="white" text-color="black">
      ...
      <!-- refresh -->
      <div class="row justify-center q-pt-xl q-pb-sm refresh-wrap">
        <div class="col-12 text-center">
      ...
      <div class="q-pt-lg q-pb-md q-pl-xs agreeDisagree-txt-wrap">
        <div class="text-center text-h5">
          {{ $t('confirm_vote_agree') }}
        </div>
      </div>
      <div class="row justify-center q-pt-md agreeDisagree-wrap">
      ...
      <div class="row justify-center q-pt-md">
        <div class="col-12 text-center">
          {{ voteVo.start_time }} ~ {{ voteVo.end_time }}
        </div>
      </div>
  ...
  <q-page class="page-default vote-detail-wrap">
    <q-tabs
      v-model="tab"
    ...
    <q-tab-panels v-model="tab">
      ...
      <q-tab-panel name="i" style="word-break: break-word;">
        <!-- <div class="row justify-center">
          <div class="col-12">
            <span class="text-weight-bold text-subtitle1 text-grey-6 t-tit">{{ $t('vote_title') }}</span>
            <q-separator />
          </div>
        </div>
        ...
        <!-- <div class="row justify-center">
          <div class="col-12">
            <span class="text-weight-bold text-subtitle1 text-grey-6 t-tit">{{ $t('vote_description') }}</span>
            <q-separator />
          </div>
        </div> -->
        <div class="q-pt-sm q-pb-md">
          <div v-if="locale === 'ko-KR'" class="row q-pb-md q-pl-xs">
            <div class="col-12 t-text" v-html="voteVo.description_ko" />
          </div>
          <div v-else class="row justify-center q-pb-md q-pl-xs">
            <div class="col-12 t-text" v-html="voteVo.description" />
          </div>
        </div>

        <div class="row justify-center">
          <div class="col-12">
            <span class="text-weight-bold text-h6 text-grey-6 t-tit">{{ $t('vote_withdrawal_request_amount') }}</span>
          </div>
        </div>
        <div class="row justify-center text-h6 q-pb-md t-stit">
          <div class="col-12">
            {{ voteVo.request_amount.toLocaleString() }} {{ symbol }}
          </div>
        </div>
      ...
      <q-pull-to-refresh @refresh="refresher">
        <q-infinite-scroll @load="loadMore" :offset="100" ref="infiniteScroll">
          <div v-for="item in voteCommentList" :key="item.seq">
            <div :style="`padding-left: ${ item.group_layer * 20 }px`" v-if="item.visible_child" :class="`${ item.group_layer === 0 ? '' : ''}`">
...
export default defineComponent({
  ...
  data () {
    return {
      ...
      platformContractBalance: '0', // 팀 자금 잔고
      progressAgree: 0.00,
