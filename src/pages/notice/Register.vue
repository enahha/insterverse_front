  ...
  <q-page class="q-pa-md page-default notice-reg-wrap">
    <div class="row justify-center page-tit">
      <div class="col-12 doc-heading doc-h2">
        {{ $t('menu_notice_register') }}
      </div>
    </div>
    <div class="row justify-center page-sub-tit">
      <div class="col-12">
        {{ $t('menu_notice_register_description') }}
      </div>
    </div>
    ...
    <div class="row justify-center q-pt-lg">
      ...
      <div class="col-6 text-right">
        <q-btn class="btn" color="secondary" text-color="black" size="lg" style="width: 98%;" @click="registerNotice" tabindex="3">
          <b>{{ $t('register') }}</b>
        </q-btn>
      </div>
    </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    registerNotice() {
      ...
      this.$axios.post('/api/notice/insertNotice', param)
        .then((result) => {
