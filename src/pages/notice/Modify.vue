<template>
  <q-page class="q-pa-md page-default notice-modify-wrap">
    ...
    <div class="row justify-center">
      <div class="col-12">
        <span class="text-weight-bold text-subtitle1">{{ $t('notice_title') }} (English)<span class="text-red"> *</span></span>
      </div>
    </div>
    <div class="row justify-center q-pb-md">
      <div class="col-12">
    ...
    <div class="row justify-center">
      <div class="col-12">
        <span class="text-weight-bold text-subtitle1">{{ $t('notice_title') }} (Korean)<span class="text-red"> *</span></span>
      </div>
    </div>
    <div class="row justify-center q-pb-md">
      <div class="col-12">
    ...
    <div class="row justify-center">
      <div class="col-12">
        <span class="text-weight-bold text-subtitle1">{{ $t('notice_contents') }} (English)<span class="text-red"> *</span></span>
      </div>
    </div>
    <div class="row justify-center q-pb-md">
      <div class="col-12">
    ...
    <div class="row justify-center">
      <div class="col-12">
        <span class="text-weight-bold text-subtitle1">{{ $t('notice_contents') }} (Korean)<span class="text-red"> *</span></span>
      </div>
    </div>
    <div class="row justify-center q-pb-md">
      <div class="col-12">
    ...
    <div class="row justify-center q-pt-lg">
      ...
      <div class="col-6 text-right">
        <q-btn class="btn" color="secondary" text-color="black" size="lg" style="width: 98%;" @click="modifyNotice" tabindex="6">
          <b>{{ $t('modify') }}</b>
        </q-btn>
      </div>
    </div>
...
export default defineComponent({
  ...
  methods: {
    async selectNotice() {
      ...
      console.log('')
      const result = await this.$axios.get('/api/notice/selectNotice', { params: { ...param } })
      if (result.data) {
    ...
    modifyNotice() {
      ...
      this.$axios.post('/api/notice/updateNotice', param)
        .then((result) => {
          // console.log(JSON.stringify(result.data))
          this.$q.loading.hide() // 로딩 표시 종료
          if (result.data && result.data.resultCd === 'SUCCESS') {
            this.$noti(this.$q, this.$t('modify_notice_success'))
          } else {
            this.$noti(this.$q, this.$t('modify_notice_failed'))
          }
