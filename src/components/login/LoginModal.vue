    ...
    <q-card style="width: 100%;">
      ...
      <table border="0" width="75%" align="center">
        ...
        <tr>
          <td colspan="3">
            <div class="col-12 text-center">
              <div class="">
                <font v-if="loginCd === 1" size="5" class="text-grey-7"><b>{{ $t('login') }}</b></font>
                <font v-if="loginCd === 2 || loginCd === 3" size="5" class="text-grey-7"><b>{{ $t('signup') }}</b></font>
                <font v-if="loginCd === 4 || loginCd === 5" size="5" class="text-grey-7"><b>{{ $t('change_pwd') }}</b></font>
              </div>
            </div>
          </td>
        </tr>
      ...
      <table v-if="loginCd === 1" border="0" width="75%" align="center">
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="userVo.uid" hide-bottom-space :placeholder="$t('id_email')" outlined style="height: 56px;" />
            </div>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="userVo.pwd" hide-bottom-space type="password" :placeholder="$t('pwd_upper')" outlined style="height: 56px;" @keyup="keyup" />
            </div>
          </td>
        </tr>
        <tr>
      ...
      <table v-if="loginCd === 2" border="0" width="75%" align="center">
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="userVo.nickname" hide-bottom-space :placeholder="$t('user_nickname')" outlined style="height: 56px;" />
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="userVo.pwd" hide-bottom-space type="password" :placeholder="$t('pwd_upper')" outlined style="height: 56px;" />
            </div>
          </td>
        </tr>
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="pwdCheck" hide-bottom-space type="password" :placeholder="$t('pwd_check_upper')" outlined style="height: 56px;" />
            </div>
          </td>
        </tr>
        <tr>
      ...
      <table v-if="loginCd === 3" border="0" width="75%" align="center">
        ...
        <tr>
          <td colspan="3" class="space">
            <div class="col-12">
              <q-input v-model="userVo.code" hide-bottom-space type="number" min="100000" max="999999" placeholder="EMAIL CODE" outlined style="height: 56px;" @keyup="onKeyUpEmailCode" />
            </div>
          </td>
        </tr>
        <tr>
      ...
      <table v-if="loginCd === 5" border="0" width="75%" align="center">
        ...
        <tr>
          <td colspan="3">
            <div class="col-12">
              <q-input v-model="userVo.code" hide-bottom-space type="number" min="100000" max="999999" placeholder="EMAIL CODE" outlined style="height: 56px;" @keyup="onKeyUpEmailCodeChangePwd" />
            </div>
          </td>
        </tr>
        <tr>
